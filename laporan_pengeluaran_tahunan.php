<?php 
	...
	$pengeluaran = query("SELECT * FROM 08_tbl_pengeluaran WHERE YEAR(tanggal) = '$tahun' ORDER BY tanggal DESC");
...
<body>
	<div class="container-fluid">
		<h3>LAPORAN PENGELUARAN TAHUNAN</h3>
		<table>
			<tr>
		...
		<table border="1" cellspacing="0" cellpadding="10" class="mt-3" width="100%">
			...
			<tr>
					...
					<th>
						<?php $total = query("SELECT SUM(nominal) as total FROM 08_tbl_pengeluaran WHERE YEAR(tanggal) = '$tahun'");
						echo $total[0]['total']; ?>
					</th>
					<td></td>
				</tr>
